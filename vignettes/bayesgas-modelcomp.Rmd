...
The dataset used in the Dynamic Pooled Marked Point Process (DPMP) models application of section 4.2 is not public. The analysis presented here is equivalent but based on simulated data.
