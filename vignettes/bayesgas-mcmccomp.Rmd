...
This document contains the R code to reproduce the plots and statistical analysis presented in section 4.1 of 
...
```{r, fig.width = 6, fig.height = 6, fig_align = 'center'}
paramPairs <- list(
...
```{r, fig.width = 10, fig.height = 6, fig_align = 'center'}
zoomDate <- "2016-09-12"
PlotHPDOverTime(
  volsGenDraws,
  returns,
...
```{r, fig.width = 5, fig.height = 5, fig.align = 'centre', results = 'hold', collapse = FALSE}
